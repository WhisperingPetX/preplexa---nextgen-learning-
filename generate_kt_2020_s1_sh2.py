...
questions = [
    ...
    },
    {
        ...
        "options": ["194.32 N", "195.66 N", "195.32 N", "194.66 N"],
        "ans": 2,
    ...
    },
    {
        ...
        "options": ["2pi a^4(A/4 + aB/5)", "pi a^4(A/4 + aB/5)", "2pi a^4(aA/4 + B/5)", "2pi a^4(A/4 + B/5)"],
        "ans": 0,
    ...
    },
    {
        ...
        "options": ["1/4 m/s", "1/2 m/s", "1/8 m/s", "1 m/s"],
        "ans": 0,
    ...
    },
    {
        ...
        "options": ["T = sqrt(T1 T2)", "T = (T1 + T2) / 2", "T = 2T1 T2 / (T1 + T2)", "T = 0"],
        "ans": 1,
    ...
    },
    {
        ...
        "options": ["66 min", "52 min", "62 min", "72 min"],
        "ans": 2,
    ...
    },
    {
        ...
        "options": ["1.0 T, 50A / m and 1.5 T", "1.5 T, 50 A/m and 1.0 T", "1.5 T, 50 A/m and 1.0 T", "150 A/m, 1.0 T and 1.5 T"],
        "ans": 0,
    ...
    },
    {
        ...
        "options": ["parallel to k", "antiparallel to (i+j)/sqrt(2)", "zero", "parallel to (i+j)/sqrt(2)"],
        "ans": 1,
    ...
    },
    {
        ...
        "options": ["56300 W", "48000 W", "66000 W", "62360 W"],
        "ans": 2,
    ...
    },
    {
        ...
        "options": ["2.5 s and 7.5 s", "2.5 s and 5.0 s", "5.0 s and 7.5 s", "5.0 s and 10.0 s"],
        "ans": 1,
    ...
    },
    {
        ...
        "options": ["1/c (2E/m)^{1/2}", "1/c (E/2m)^{1/2}", "(E/2m)^{1/2}", "c(2mE)^{1/2}"],
        "ans": 1,
    ...
    },
    {
        ...
        "options": ["9/16", "sqrt(3)/2", "3/4", "81/256"],
        "ans": 0,
    ...
    },
    {
        ...
        "options": ["ML^2T^-2", "MLT^-2", "ML^-1T^-2", "ML^2T^-1"],
        "ans": 2,
    ...
    },
    {
        ...
        "options": ["(1/2)^((gamma+1)/2)", "1/2", "(1/2)^gamma", "2"],
        "ans": 0,
    ...
    # CHEMISTRY
    {
        ...
        "options": ["(c) and (d) only", "(a) and (d) only", "(a) and (b) only", "(b) and (c) only"],
        "ans": 1,
    ...
    },
    {
        ...
        "options": ["4-bromo-2-methylacetanilide", "2-acetyl-4-methylacetanilide", "N-(4-(bromomethyl)phenyl)acetamide", "2-bromo-4-methylacetanilide"],
        "ans": 3,
    ...
    },
    {
        ...
        "options": ["(a), (c) and (d) only", "(a), (b), (c) and (d)", "(a) and (c) only", "(a), (b) and (c) only"],
        "ans": 1,
    ...
    },
    {
        ...
        "options": ["(C) > (A) > (B)", "(B) > (C) > (A)", "(B) > (A) > (C)", "(C) > (B) > (A)"],
        "ans": 3,
    ...
    },
    {
        ...
        "options": ["(B), (C) and (A)", "(C), (A) and (B)", "(A), (B) and (C)", "(B), (A) and (C)"],
        "ans": 1,
    ...
    },
    {
        ...
        "options": ["NaClO3 and Ca(ClO3)2", "NaClO3 and Ca(OCl)2", "NaOCl and Ca(OCl)2", "NaOCl and Ca(ClO3)2"],
        "ans": 1,
    ...
    },
    {
        ...
        "options": ["200 ml of 0.4 N HCl", "200 ml of 0.2 N HCl", "100 ml of 0.1 N HCl", "100 ml of 0.2 N HCl"],
        "ans": 3,
    ...
    },
    {
        ...
        "options": ["mu_B > mu_A and ke(A) > ke(B)", "mu_B > mu_A and ke(B) > ke(A)", "mu_A > mu_B and ke(B) > ke(A)", "mu_A > mu_B and ke(A) > ke(B)"],
        "ans": 2,
    ...
    },
    {
        ...
        "options": ["A - V_rms; B - V_mp; C - V_av", "A - V_mp; B - V_av; C - V_rms", "A - V_mp; B - V_rms; C - V_av", "A - V_av; B - V_rms; C - V_mp"],
        "ans": 1,
    ...
    },
    {
        ...
        "options": ["(Lambda_m^0)_NaBr - (Lambda_m^0)_NaCl = (Lambda_m^0)_KBr - (Lambda_m^0)_KCl", "(Lambda_m^0)_H2O = (Lambda_m^0)_HCl + (Lambda_m^0)_NaOH - (Lambda_m^0)_NaCl", "(Lambda_m^0)_NaBr - (Lambda_m^0)_NaI = (Lambda_m^0)_KBr - (Lambda_m^0)_NaBr", "(Lambda_m^0)_KCl - (Lambda_m^0)_NaCl = (Lambda_m^0)_KBr - (Lambda_m^0)_NaBr"],
        "ans": 2,
    ...
    },
    {
        ...
        "options": ["combination of dinitrogen with dioxygen at 200 K", "reaction of H2SO4 with NaOH", "formation of ozone from atmospheric oxygen in the presence of sunlight", "reaction of [Co(H2O)6]Cl3 with AgNO3"],
        "ans": 0,
    ...
    },
    {
        ...
        "options": ["kb[N2][H2O]^2/[H2]", "kb[N2][H2O]", "kb[N2][H2O]^2/[NO]", "kb[N2][H2O]^2"],
        "ans": 0,
    ...
    },
    {
        ...
        "options": ["2.5, diamagnetic", "3, paramagnetic", "2.5, paramagnetic", "3, diamagnetic"],
        "ans": 3,
    ...
    },
    {
        ...
        "options": ["An open chain ether", "A cyclic ether", "A cyclic ester", "A spiro compound"],
        "ans": 3,
    ...
    },
    {
        ...
        "options": ["Gluconic acid is obtained by oxidation of glucose with HNO3", "Gluconic acid is a partial oxidation product of glucose", "Gluconic acid can form cyclic (acetal/hemiacetal) structure", "Gluconic acid is a dicarboxylic acid"],
        "ans": 1,
    ...
    },
    {
        ...
        "options": ["Cl, S and Li", "F, Se and Na", "Cl, Se and Na", "F, S and Li"],
        "ans": 0,
    ...
    },
    {
        ...
        "options": ["distillation", "liquation", "zone refining", "vapour phase refining"],
        "ans": 1,
    ...
    },
    {
        ...
        "options": ["0 and 1", "0 and 0", "0 and 2", "2 and 2"],
        "ans": 1,
    ...
    },
    {
        ...
        "options": ["(a) and (b)", "(b) and (d)", "(a) and (d)", "(b), (c) and (d)"],
        "ans": 1,
    ...
    },
    {
        ...
        "options": ["log_e sqrt(2)", "log_e(3/2)", "log_e(4/3)", "log_e 2"],
        "ans": 3,
    ...
    },
    {
        ...
        "options": ["f is an odd function", "f(1) - 4f(-1) = 4", "x = 1 is a point of minima and x = -1 is a point of maxima of f", "x = 1 is a point of maxima and x = -1 is a point of minimum of f"],
        "ans": 3,
    ...
    },
    {
        ...
        "options": ["(-3/2, 3c x b)", "(-3/2, 3a x b)", "(3/2, 3b x c)", "(3/2, 3a x c)"],
        "ans": 1,
    ...
    },
    {
        ...
        "options": ["2/sqrt(5)", "sqrt(5)/2", "-sqrt(5)/4", "-sqrt(5)/2"],
        "ans": 3,
    ...
    },
    {
        ...
        "options": ["p5 = p2 . p3", "p3 = p5 - p4", "p1 + p2 + p3 + p4 + p5 = 26", "p5 = 11"],
        "ans": 0,
    ...
    },
    {
        ...
        "options": ["128/3", "127/3", "124/3", "125/3"],
        "ans": 0,
    ...
    },
    {
        ...
        "options": ["pi/3", "pi/9", "pi/3 + 1/6", "2pi/3"],
        "ans": 0,
    ...
    },
    {
        ...
        "options": ["4", "2 sqrt(2)", "2 sqrt(5)", "2 sqrt(7)"],
        "ans": 3,
    ...
    },
    {
        ...
        "options": ["2x - 3y = 0", "5x - 7y = 0", "7x - 5y = 0", "3x - 2y = 0"],
        "ans": 1,
    ...
    },
    {
        ...
        "options": ["(4 - sqrt(5))/3", "2/3", "(sqrt(7) - 2)/3", "(4 - sqrt(7))/3"],
        "ans": 3,
    ...
    },
    {
        ...
        "options": ["If A not subset C, then A subset B and B subset D", "If A not subset C, then A not subset B and B subset D", "If A not subset C, then A not subset B or B not subset D", "If A subset C, then B subset A or D subset B"],
        "ans": 2,
    ...
    },
    {
        ...
        "options": ["pi - tan^-1(3/4)", "pi - tan^-1(4/3)", "tan^-1(4/3)", "-tan^-1(3/4)"],
        "ans": 1,
...
out = """package com.example.data.repository
...
for q in questions:
    ...
    subj_label = "Physics"
    if subj == 'chem': subj_label = "Chemistry"
    if subj == 'math': subj_label = "Mathematics"
    
    full_text = json.dumps(q['text'])
    opts = [json.dumps(opt) for opt in q['options']]
    sol = json.dumps(sol)
    
    out += f"""            Question(
                id = "${{testId}}_s1_sh2_q{q_num}_{subj}",
                topicId = testId,
                text = {full_text},
                options = listOf({opts[0]}, {opts[1]}, {opts[2]}, {opts[3]}),
...
with open('app/src/main/java/com/example/data/repository/JeeMain2020Session1Shift2QuestionsRepository.kt', 'w', encoding='utf-8') as f:
    f.write(out)

print("Generated repository successfully.")
